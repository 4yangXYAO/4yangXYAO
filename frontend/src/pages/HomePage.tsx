...
export const HomePage = () => {
  ...
  const defaultProjects = [
    {
      _id: "m1",
      title: "SHOP_ECOMMERCE",
      description:
        "Website toko online dengan fitur keranjang belanja dan manajemen produk.",
    ...
    {
      _id: "m2",
      title: "NET_MONITOR_SYS",
      description:
        "Sistem monitoring infrastruktur jaringan dan kesehatan server secara real-time.",
      technologies: ["React", "SNMP", "Node.js", "Grafana"],
      slug: "net-monitor-sys",
      featured: true,
      order: 2,
      image: "https://images.unsplash.com/photo-1551288049-bb848a4fb6c5?w=800",
    },
    {
      _id: "m3",
      title: "IT_SUPPORT_PORTAL",
      description:
        "Portal tiket bantuan teknis untuk menangani keluhan hardware dan software pengguna.",
    ...
    },
    {
      ...
      description:
        "Panel administrasi untuk pengelolaan data pengguna dan statistik sistem.",
    ...
    {
      _id: "m5",
      title: "NET_TOPOLOGY_MAPPER",
      description:
        "Alat visualisasi dinamis untuk memetakan titik-titik jaringan area lokal (LAN).",
    ...
    },
    {
      ...
      title: "PORTFOLIO_WEB",
      description:
        "Website portofolio pribadi untuk menampilkan rekam jejak karir dan karya teknis.",
    ...
    },
    {
      ...
      title: "AI_CHATBOT",
      description:
        "Chatbot berbasis kecerdasan buatan untuk membantu tanya jawab teknis dasar.",
    ...
    },
    {
      ...
      description:
        "Aplikasi produktivitas untuk mengelola daftar tugas dan kolaborasi tim.",
    ...
    {
      _id: "m9",
      title: "HARDWARE_INVENTORY",
      description:
        "Sistem pendataan inventaris perangkat keras IT dan riwayat pemeliharaannya.",
    ...
    },
    {
      ...
      title: "BLOG_PLATFORM",
      description:
        "Platform penulisan artikel blogger dengan dashboard manajemen konten.",
    ...
    {
      _id: "m11",
      title: "COFFEE_SHOP_SITE",
      description:
        "Website profil untuk kedai kopi dengan menu interaktif dan lokasi toko.",
      technologies: ["React", "Tailwind", "Vite"],
      slug: "coffee-shop-site",
      featured: false,
      order: 11,
      image:
        "https://images.unsplash.com/photo-1501339818194-919992f70355?w=800",
    },
    {
      _id: "m12",
      title: "SCHOOL_INFO_SYSTEM",
      description:
        "Sistem informasi untuk mengelola data siswa, guru, dan jadwal pelajaran sekolah.",
    ...
    {
      _id: "m13",
      title: "COMPANY_LANDING_PAGE",
      description:
        "Halaman landing profesional untuk mempromosikan layanan dan profil perusahaan.",
    ...
    },
    {
      ...
      description:
        "Aplikasi pemesanan jasa service secara online dengan jadwal yang fleksibel.",
    ...
    {
      _id: "m15",
      title: "NEWS_PORTAL_WEB",
      description:
        "Portal berita online dengan kategori artikel dan update berita terkini.",
    ...
    },
    {
      ...
      description:
        "Platform simulasi ujian dan kuis online dengan sistem penilaian otomatis.",
    ...
    },
    {
      ...
      description:
        "Aplikasi pelacak cuaca harian berdasarkan lokasi pengguna secara real-time.",
      technologies: ["OpenWeatherMap API", "React", "Geolocation"],
    ...
    {
      _id: "m18",
      title: "REST_API_SERVER",
      description:
        "Layanan backend API untuk pengolahan dan pertukaran data aplikasi.",
    ...
    {
      _id: "m19",
      title: "PERSONAL_DIARY_WEB",
      description:
        "Situs catatan harian pribadi dengan fitur enkripsi dan keamanan data.",
    ...
    {
      _id: "m20",
      title: "EVENT_TICKETING",
      description:
        "Sistem reservasi tiket untuk acara konser, seminar, atau kegiatan sosial.",
    ...
    <div className="relative">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 pt-32 pb-20 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, #00daf7 1px, transparent 1px), linear-gradient(to bottom, #00daf7 1px, transparent 1px)",
        ...
        >
          BUILD <br />
          <span className="text-[#00daf7] drop-shadow-[0_0_30px_rgba(0,218,247,0.2)]">
            EVERYTHING
          </span>
        </motion.h1>
        ...
        >
          ...
          <p className="font-sans text-gray-300 max-w-2xl text-xl md:text-2xl italic leading-relaxed px-4">
            ...
            <span className="block mt-4 text-[#00daf7]/60 font-mono text-[10px] tracking-[0.3em] uppercase not-italic">
              EXECUTED_BY::{profile?.name?.toUpperCase() || "KHARIS_JALALUDIN"}
            </span>
          </p>
        </motion.div>
        ...
        >
          <Link
            to="/about"
            className="cyber-glow-btn px-12 py-4 flex items-center gap-4 group"
          >
            <span>ABOUT_ME</span>
        ...
        <div className="absolute left-10 top-1/2 -translate-y-1/2 hidden xl:flex flex-col items-center gap-4 opacity-20">
          <span className="font-mono text-[9px] rotate-90 origin-left translate-x-4 mb-20 whitespace-nowrap tracking-widest text-[#00daf7]">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 py-32 border-t border-white/5">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          <div className="cyber-rail-l pl-8">
            <div className="font-mono text-[10px] text-[#00daf7] tracking-[0.5em] mb-4">
              CORE_COMPETENCIES
            </div>
            <h2 className="text-4xl md:text-6xl text-white font-display tracking-tight">
              TECHNICAL_MASTERY
            </h2>
          </div>
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden my-20">
        ...
        <div className="relative z-10 border-x-4 border-[#00daf7] px-20 py-8 bg-[#000000]/40 backdrop-blur-sm">
          <h2 className="text-3xl md:text-5xl font-mono tracking-[0.6em] text-[#00daf7]">
            LIMITLESS_CONTROL
          </h2>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 pb-48">
        <div className="flex justify-between items-end mb-24">
          <div className="cyber-rail-l pl-8">
            <div className="font-mono text-[10px] text-[#00daf7] tracking-[0.5em] mb-4 uppercase">
              MISSION_LOG
            </div>
            <h2 className="text-4xl md:text-6xl text-white font-display tracking-tight uppercase">
              SELECTED_ARCHIVES
            </h2>
          </div>
          <Link
            to="/projects"
            className="text-[#00daf7] font-mono text-[10px] tracking-widest hover:underline mb-4"
          >
            VIEW_ALL_MODS
          </Link>
        </div>
...
const SkillCard = ({ number, title, description, tags, icon }: any) => (
  <div className="group relative glass-panel p-10 cyber-rail-l hover:border-[#00daf7]/60 transition-all duration-500 overflow-hidden">
    ...
    <span className="material-symbols-outlined text-[#00daf7] text-5xl mb-8 group-hover:scale-110 transition-transform">
      {icon}
    </span>
    <h3 className="text-white font-display text-2xl mb-4 tracking-tight uppercase">
      {title}
    </h3>
